...
This is a basic example. See
[`vignette("longcfa")`](https://marklhc.github.io/longcfa/articles/longcfa.md)
for a longer example. The package also supports

- Invariance constraints and partial invariance, as discussed in [this
  article](https://marklhc.github.io/longcfa/articles/invariance.md).
- Categorical indicators, as discussed in
  [`vignette("cat")`](https://marklhc.github.io/longcfa/articles/cat.md).
- Penalized estimation to obtain approximate invariance, as discussed in
  [`vignette("penalized")`](https://marklhc.github.io/longcfa/articles/penalized.md).
- Automatic specification search by relaxing invariance constraints one
  at a time, as discussed in
  [`vignette("specification-search")`](https://marklhc.github.io/longcfa/articles/specification-search.md).
