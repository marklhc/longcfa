...
First, we try the ALF penalty with a tuning parameter of 0.1 (which is arbitrary). We need to identify the corresponding ID for the loadings and intercepts parameter, using the `get_lav_par_id()` function.
